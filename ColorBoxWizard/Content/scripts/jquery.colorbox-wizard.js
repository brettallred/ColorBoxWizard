...
(function ($, document, window) {
    ...
    function captureForms() {
        $("#cboxLoadedContent").on("submit", "form", function (event) {
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    var updateAttribute = $form.getAttribute("data-updateElement");
                    if (updateAttribute) {
                        $(updateAttribute).append(data);
                        publicMethod.resize();
                    } else {
                        settings.html = data;
    ...
    function captureLinks() {
        $("#cboxLoadedContent").on("click", "a", function (event) {
    ...
    publicMethod.init = function () {
        if (!$box) {
            ...
            // TODO: Insert $error = $tag(div, "ErrorContent")
